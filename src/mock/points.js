...
const DESTINATIONS_NAMES = ['Ekaterinburg', 'Amsterdam', 'Geneva', 'Moscow', 'Astana'];
...
export { POINT_TYPES, OFFER_TITLES, DESCRIPTIONS, DESTINATIONS_NAMES, tripPrice, offerPrice, createRandomDates, createPoint  };
